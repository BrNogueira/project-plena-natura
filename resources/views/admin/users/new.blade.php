  ...
  <form method="POST">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" required name="name" class="form-control" required id="inputEmail4" placeholder="Nome">
      </div>
      <div class="form-group col-md-6">
        <label for="lastname">Sobrenome</label>
        <input type="text" required name="lastname" class="form-control" id="lastname" required placeholder="Sobrenome">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="email">Email</label>
        <input type="email" required name="email" class="form-control" id="email" required placeholder="email@email.com">
      </div>

      <div class="form-group col-md-6">
        <label for="password">Senha</label>
        <input type="password" required name="password" class="form-control" required id="password" placeholder="Senha">
      </div>
    </div>
