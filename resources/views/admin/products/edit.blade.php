...
<div class="form-group">
  ...
  <div class="form-group">
    <label for="exampleFormControlTextarea1" style="display: block">Thumbnail</label>
    <input type="file" id="thumbnail" name="thumbnail" onchange="loadFile(event)" style="display: block;">
    <img id="output" style="display: block; max-width: 200px; max-height: 200px" src="{{ asset('storage/products/' . $product->thumbnail) }}" />
  </div>
