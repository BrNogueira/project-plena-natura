        ...
        <div class="wrapper">
            ...
            <article>
                <div class="editar-endereco">
                    <h2>
                        <i class="fa fa-home" aria-hidden="true"></i>Novo endereço
                    </h2>
                    ...
                    <form method='POST'>
                        ...
                        <label>
                            ...
                            <input name='cep' id='cep' requiredtype="text">
                        </label>
                        <div class="half">
                            <label>
                                <span>
                        ...
                        <label>
                            ...
                            <input name='district' id='district' required type="text">
                        </label>
                        <div class="half">
                            <label>
                                <span>
                                ...
                                <input name='street' id='street' required type="text">
                            </label>
                            <label>
                                <span>
                                    Número
                        ...
                        <label>
                            ...
                            <input name='complements' type="text">
                        </label>
